...
g1 <- g1 + xlab("Threshold (cm)") + ylab("Utility") + theme_gray(20) 
g1
...
g2 <- g2 + xlab("Threshold (cm)") + ylab("Adjective degree") + theme_gray(20) 
g2
...
g2 <- g2 + geom_area(aes(y=sigma_probs),fill="red", alpha=.4) 
g2 <- g2 + xlab("IQ") + ylab("Adjective degree") + theme_gray(20) 
g2
...
g2 <- g2 + geom_area(aes(y=sigma_probs),fill="red", alpha=.4) 
g2 <- g2 + xlab("Waiting time (m)") + ylab("Adjective degree") + theme_gray(20) 
g2
