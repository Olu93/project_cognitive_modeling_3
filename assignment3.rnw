...
g1 <- g1 + xlab("Threshold (cm)") + ylab("P") + theme_gray(20) 
g1
...
denf_left <- function(x){dgamma(x, 4, 1.5)}
cumf_left <- function(x){pgamma(x, 4, 1.5)} 
...
cor_left_1 <- round(cor(data.left$percentage[data.left$Adjective == "big"], sapply(degree.points, function(x) {use.adjective(x, degree.points, 40, 0.1, denf_left, cumf_left, threshold_func_left)}), method="pearson"), 2)
...
cor_left_2 <- round(cor(data.left$percentage[data.left$Adjective == "big"], sapply(degree.points, function(x) {use.adjective(x, degree.points, 40, -0.1, denf_left, cumf_left, threshold_func_left)}), method="pearson"), 2)
cor_left_3 <- round(cor(data.left$percentage[data.left$Adjective == "big"], sapply(degree.points, function(x) {use.adjective(x, degree.points, 40, 0, denf_left, cumf_left, threshold_func_left)}), method="pearson"), 2)
